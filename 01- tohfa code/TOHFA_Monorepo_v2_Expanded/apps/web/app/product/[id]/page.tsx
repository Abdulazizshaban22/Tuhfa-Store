interface Product { externalId:string; titleAr:string; priceSar:number; status:string; craftType?:{nameAr:string}; artisan?:{nameAr:string; storeHandle:string}; passport?:{qrText:string}; }
