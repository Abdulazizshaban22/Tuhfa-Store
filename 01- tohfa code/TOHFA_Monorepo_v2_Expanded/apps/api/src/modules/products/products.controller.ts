...
export class ProductsController {
  ...
  list(
    ...
    return this.svc.findMany({ q, craftTypeCode, regionCode, patterns, materials, take: parseInt(take,10), skip: parseInt(skip,10) });
  }
  @Get(':externalId') get(@Param('externalId') externalId: string) { return this.svc.findByExternalId(externalId); }
}
